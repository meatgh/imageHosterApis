...
public class ImageUploadController {
    ...
    public ResponseEntity<ImageUploadResponse> imageupload(final ImageUploadRequest imageUploadRequest, final String authorisationToken) throws UploadFailedException {
        ...
        final ImageEntity createdimageEntity = imageUploadService.upload(imageEntity, authorisationToken);
